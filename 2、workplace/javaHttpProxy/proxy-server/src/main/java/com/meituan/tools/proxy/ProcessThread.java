...
class ProcessThread implements Callable<Object>, Closeable, Constants {
    ...
    public ProcessThread(HttpProxyServer parent, Socket socket) {
        this.parent = parent;
        this.socket = socket;
    }
    ...
    public Object call() throws Exception {
        try {
            System.out.println("now in ProcessThread call() " + Thread.currentThread().getName());
...
//        System.out.println("now in ProcessThread reply() " + Thread.currentThread().getName());
